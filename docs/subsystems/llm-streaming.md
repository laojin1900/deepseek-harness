 ...
 * @returns the disposer that withdraws the offer.
 */
registerQuota( settingsNs: string, query: (request: LlmQuotaRequest) => Promise<LlmQuotaResult>, ): () => void
 ...
 */
@Remote('getQuota') async remoteGetQuota(provider: string, signal: AbortSignal): Promise<LlmQuotaResult>
