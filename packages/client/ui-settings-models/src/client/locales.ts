...
export const en = {
  ...
  imageInputHint: 'Lets undeclared models on this provider accept images. Catalog models keep their own modalities.',
  modelImageInput: 'Accepts images',
  modelImageInputHint: 'Unset inherits the provider default.',
  modelImageInputInherit: 'Provider default',
  modelImageInputOn: 'Text and images',
  modelImageInputOff: 'Text only',
  addModel: 'Add model',
  ...
  subscriptionTitle: 'Subscription sign-in',
  subscriptionIntro: 'Sign in with a subscription account, such as ChatGPT, instead of an API key. The credential stays on this machine and the provider models become available as soon as the sign-in completes.',
  subscriptionSignIn: 'Sign in',
  subscriptionInFlight: 'Signing in…',
  subscriptionSignedIn: 'Signed in',
  subscriptionMethod: 'Sign-in method',
  subscriptionSubmit: 'Submit',
  subscriptionDone: 'Done',
  subscriptionStartFailed: 'Could not start the sign-in: {message}',
  subscriptionFailed: 'Sign-in failed: {message}',
  subscriptionProfileFailed: 'Signed in, but declaring the provider profile failed: {message}',
  subscriptionAuthorized: '{provider} is signed in; its models are now available.',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '容量',
  imageInput: '图片输入',
  imageInputHint: '让该提供方未单独声明的模型接受图片。目录模型仍使用各自的模态。',
  modelImageInput: '接受图片',
  modelImageInputHint: '不设置则继承提供方默认值。',
  modelImageInputInherit: '提供方默认',
  modelImageInputOn: '文本和图片',
  modelImageInputOff: '仅文本',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  subscriptionTitle: '订阅登录',
  subscriptionIntro: '使用订阅账号（例如 ChatGPT）登录，无需 API 密钥。凭据保存在本机，登录完成后该提供方的模型即可选用。',
  subscriptionSignIn: '登录',
  subscriptionInFlight: '登录中…',
  subscriptionSignedIn: '已登录',
  subscriptionMethod: '登录方式',
  subscriptionSubmit: '提交',
  subscriptionDone: '完成',
  subscriptionStartFailed: '无法发起登录：{message}',
  subscriptionFailed: '登录失败：{message}',
  subscriptionProfileFailed: '已登录，但写入提供方配置失败：{message}',
  subscriptionAuthorized: '{provider} 已登录，其模型现在可以选用。',
}
