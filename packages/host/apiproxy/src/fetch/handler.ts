...
import { llmDiscoverModelsRequestSchema, llmModelsRequestSchema, llmProvidersRequestSchema, llmQuotaRequestSchema } from '../api/llm.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'llm.quota': { schema: llmQuotaRequestSchema, invoke: (api, r, signal) => api.llm.quota(r, signal) },
}
