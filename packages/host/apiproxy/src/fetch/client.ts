...
import { llmDiscoverModelsValueSchema, llmModelsValueSchema, llmProvidersValueSchema, llmQuotaValueSchema } from '../api/llm.schema.ts'
import {
...
export interface IApiClient {
  ...
  llm: {
    ...
    quota(payload: RequestPayload<'llm.quota'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.quota'>>>
  }
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly llm: IApiClient['llm'] = {
    ...
    quota: (payload, signal) => this.callUnary('llm.quota', payload, signal),
  }
