...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  LlmQuotaRequest: 'local quota contract is owned by packages/llm/llm/src/index.ts and documented with ctx.llm in docs/subsystems/llm-streaming.md',
  LlmQuotaResult: 'local quota contract is owned by packages/llm/llm/src/index.ts and documented with ctx.llm in docs/subsystems/llm-streaming.md',
}
